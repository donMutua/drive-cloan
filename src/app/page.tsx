          ...
          <div className="flex flex-col w-full max-w-[960px] py-5 flex-1">
                ...
                >
                  <div className="flex flex-col gap-2 text-left">
                    <h1 className="text-white text-4xl font-black leading-tight tracking-[-0.033em] @[480px]:text-5xl @[480px]:font-black @[480px]:leading-tight @[480px]:tracking-[-0.033em]">
                      A new home for your documents, spreadsheets, and presentations
                    </h1>
                    <h2 className="text-white text-sm font-normal leading-normal @[480px]:text-base @[480px]:font-normal @[480px]:leading-normal">
                      Import your existing files or create new ones in our editor. Collaborate in
                      real-time with other users and store all of your files securely in Drive.
                    </h2>
                  </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 p-4">
              {[
                ...
                {
                  title: 'Drawings',
                  description: 'Create a new drawing or add it to an existing document.',
                  image:
                ...
                {
                  title: 'Sites',
                  description: 'Create a new site on your own or with others at the same time.',
                  image:
